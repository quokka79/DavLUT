function cmap_PeachPassion = PeachPassion(ColourBins,BrightnessMin,BrightnessMax)
% Generates a colormap (cmap_PeachPassion)
%
...
%                  to BrightnessMax.
    ...
    cmap_PeachPassion = horzcat(r,g,b);
